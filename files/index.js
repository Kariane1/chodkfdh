...
const port = process.env.SERVER_PORT || process.env.PORT || 5600;        
const UUID = process.env.UUID || '72fa32ea-e312-49e1-9708-31831a75ec7d'; //若需要改UUID，需要在config.json里改为一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'cho13.autumnhascome.cf';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiMjUxNzhjNWNkNTllZWU3MDc4MmU0MDZhZTViMTVmM2QiLCJ0IjoiY2JkMTJkN2QtMTJkYi00NjQ2LTgxN2ItYTFmNjY4N2U4ZjgwIiwicyI6IlpqZzFZV1UyWTJVdFpXUTRPUzAwWkRFNUxXRmxNVEV0WkRZd1lqazJaR00zWldOaSJ9';
